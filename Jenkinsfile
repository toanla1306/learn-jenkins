  ...
  //                               sh "mvn -X clean deploy"
		...
		stage("deploy to tomcat"){
			steps{
				...
				sh "mvn archetype:generate -DgroupId=org.springframework.samples -DaritfactId=spring-petclinic -DarchetypeArtifactId=maven-archetype-quickstart -DinteractiveMode=false"
